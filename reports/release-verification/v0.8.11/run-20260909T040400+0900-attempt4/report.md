...
```
  ...
  Downloaded thiserror v2.0.20
   ...
   Compiling alopex-release-verifier v0.0.0 (/tmp/tmp.gAocOLh26u)
    Finished `release` profile [optimized] target(s) in 26m 21s
...
```
python3: can't open file '/workspace/scripts/parity/verify.py': [Errno 2] No such file or directory
```
...
|---|---|
| 対象バージョン | v0.8.11 |
| 生成日時 (UTC) | 2026-09-08T18:59:00.281615Z |
